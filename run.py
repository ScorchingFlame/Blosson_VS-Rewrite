...
def run(n: bool, ip, port: int, username, password):
    if n:
        message = f"""                Voting System application Coded By Ritheesh
!!READ THIS BEFORE DOING ANYTHING!!     
        Creating/Inserting Voter:
                    - Remember not a Create/Insert a Voter With a Same Admission ID as Others
                    - Remember That This Voting System Supports from 3rd Grade To 12th Grade
                    - Remember To Have The House Name as Capitalized, Example: WINTER, SUMMER and SPRING
                    * Excel Inserting:
                        - If you Get Error When Inserting Excel Sheet, Try These:
                            ...
                            : Check If All The Alphabet of House Are Capital Letter             
